...
class MyCred_Learndash_Leaderboard {
    ...
    public function mycred_leaderboard_based_lesson($post_id, $course_id) {
        ...
        $lesson_cats = isset($lesson_based['leaderboard_course_lesson_cat']) ? $lesson_based['leaderboard_course_lesson_cat'] : '';
    ...
    public function mycred_learndash_leaderboard_save( $post_id, $post, $update ) {
        ...
        if ( isset( $_POST['mycred_leaderboard_box_nonce'] ) && ! wp_verify_nonce( $_POST['mycred_leaderboard_box_nonce'], basename(__FILE__) ) ) {
                return $post_id;
        }
        ...
        if ( isset( $_POST['leaderboard_setting'] ) ) {
            ...
            foreach ( $_POST['leaderboard_setting'] as $key => $value ) {
                if ( 
                    ( ! in_array( $key , array( 'leaderboard_pagination', 'leaderboard_timefilter' ) ) ) ||
